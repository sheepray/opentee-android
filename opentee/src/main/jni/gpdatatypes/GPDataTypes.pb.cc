...
void protobuf_AssignDesc_GPDataTypes_2eproto() {
  ...
  static const int TeecSharedMemory_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TeecSharedMemory, midinjni_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TeecSharedMemory, mid_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TeecSharedMemory, moffset_),
  };
  ...
  TeecValue_descriptor_ = file->message_type(3);
...
void protobuf_AddDesc_GPDataTypes_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "g.opentee.imps.pbdatatypesB\013GpDataTypes", 559);
...
const int TeecSharedMemory::kMIDInJniFieldNumber;
const int TeecSharedMemory::kMIDFieldNumber;
const int TeecSharedMemory::kMOffsetFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_mIDInJni;
        break;
      }

      // required int32 mIDInJni = 4;
      case 4: {
        if (tag == 32) {
         parse_mIDInJni:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_mOffset;
        break;
      }

      // required int32 mOffset = 6;
      case 6: {
        if (tag == 48) {
         parse_mOffset:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
...
void TeecSharedMemory::SerializeWithCachedSizes(
  ...
  // required int32 mIDInJni = 4;
  if (has_midinjni()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(4, this->midinjni(), output);
  }
  ...
  // required int32 mOffset = 6;
  if (has_moffset()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(6, this->moffset(), output);
  }
...
::google::protobuf::uint8* TeecSharedMemory::SerializeWithCachedSizesToArray(
  ...
  // required int32 mIDInJni = 4;
  if (has_midinjni()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(4, this->midinjni(), target);
  }
  ...
  // required int32 mOffset = 6;
  if (has_moffset()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(6, this->moffset(), target);
  }
...
void TeecSharedMemory::MergeFrom(const TeecSharedMemory& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_midinjni()) {
      set_midinjni(from.midinjni());
    }
    if (from.has_mid()) {
      set_mid(from.mid());
    }
...
void TeecSharedMemory::Swap(TeecSharedMemory* other) {
  if (other != this) {
    ...
    std::swap(midinjni_, other->midinjni_);
