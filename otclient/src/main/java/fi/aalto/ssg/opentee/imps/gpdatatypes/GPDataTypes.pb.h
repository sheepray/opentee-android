...
class TeecSharedMemory : public ::google::protobuf::Message {
 public:
  ...
  static const int kMOffsetFieldNumber = 6;
...
// required int32 mOffset = 6;
inline bool TeecSharedMemory::has_moffset() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void TeecSharedMemory::set_has_moffset() {
  _has_bits_[0] |= 0x00000020u;
}
inline void TeecSharedMemory::clear_has_moffset() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void TeecSharedMemory::clear_moffset() {
  moffset_ = 0;
  clear_has_moffset();
}
inline ::google::protobuf::int32 TeecSharedMemory::moffset() const {
  // @@protoc_insertion_point(field_get:fi.aalto.ssg.opentee.imps.pbdatatypes.TeecSharedMemory.mOffset)
  return moffset_;
}
inline void TeecSharedMemory::set_moffset(::google::protobuf::int32 value) {
  set_has_moffset();
  moffset_ = value;
  // @@protoc_insertion_point(field_set:fi.aalto.ssg.opentee.imps.pbdatatypes.TeecSharedMemory.mOffset)
}
