 ...
 *     4. TEE Service(Proxy) Manager: Android service layer abstraction for TEE who is responsible for handling
 *     incoming connection from CAs and communicating with TEE with the help of Native Libtee;<br>
 ...
 *the Client Android Application should communicate with the Remote TEE service manager.
 *<p>
 ...
 *     utilizing the functions of the Trusted Application;<br>
 ...
 *    Linux, Android or iOS etc. It abstracts the underlying hardware and provides resources for the
 ...
 *    keys against these attacks, it is good to keep these information safe in a separate container in case
 ...
 *    developers to debug and deploy TAs before shipping applications to real TEE.
 *<p>
 ...
 *    What's more, all the implementations of public APIS are open-source for everyone. By taking advices from other developers,
